...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'back.twig.dash_extension' => 'getBack_Twig_DashExtensionService',
            'booking.twig_extension' => 'getBooking_TwigExtensionService',
            'cache_clearer' => 'getCacheClearerService',
            'cache_warmer' => 'getCacheWarmerService',
            'caisse.twig_extension' => 'getCaisse_TwigExtensionService',
            'client.security.interactive_login_listener' => 'getClient_Security_InteractiveLoginListenerService',
            'contact.twig_extension' => 'getContact_TwigExtensionService',
            ...
            'kernel.listener.main_front_exception_listener' => 'getKernel_Listener_MainFrontExceptionListenerService',
            ...
            'md5salted_encoder' => 'getMd5saltedEncoderService',
            ...
            'notiflistener' => 'getNotiflistenerService',
            ...
            'user_user.registration.form.type' => 'getUserUser_Registration_Form_TypeService',
            ...
            'your.own.twig.controller_action_extension' => 'getYour_Own_Twig_ControllerActionExtensionService',
        );
        $this->aliases = array(
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'BackCommandeBundle', ($this->targetDirs[2].'/Resources/BackCommandeBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'BackCommandeBundle', ($this->targetDirs[3].'/src/Back/CommandeBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'MainFrontBundle', ($this->targetDirs[2].'/Resources/MainFrontBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'MainFrontBundle', ($this->targetDirs[3].'/src/Main/FrontBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'BackPartnerBundle', ($this->targetDirs[2].'/Resources/BackPartnerBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'BackPartnerBundle', ($this->targetDirs[3].'/src/Back/PartnerBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'BackPlanningBundle', ($this->targetDirs[2].'/Resources/BackPlanningBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'BackPlanningBundle', ($this->targetDirs[3].'/src/Back/PlanningBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'BackDealBundle', ($this->targetDirs[2].'/Resources/BackDealBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'BackDealBundle', ($this->targetDirs[3].'/src/Back/DealBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'BackDashBundle', ($this->targetDirs[2].'/Resources/BackDashBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'BackDashBundle', ($this->targetDirs[3].'/src/Back/DashBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
    ...
    /**
     * Gets the 'back.twig.dash_extension' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Back\DashBundle\Twig\TwigExtension A Back\DashBundle\Twig\TwigExtension instance.
     */
    protected function getBack_Twig_DashExtensionService()
    {
        return $this->services['back.twig.dash_extension'] = new \Back\DashBundle\Twig\TwigExtension($this->get('doctrine.orm.default_entity_manager'), $this->get('security.context'));
    }

    /**
     * Gets the 'booking.twig_extension' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Main\BookingBundle\Twig\Extension\BookingExtension A Main\BookingBundle\Twig\Extension\BookingExtension instance.
     */
    protected function getBooking_TwigExtensionService()
    {
        return $this->services['booking.twig_extension'] = new \Main\BookingBundle\Twig\Extension\BookingExtension($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    /**
     * Gets the 'caisse.twig_extension' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Back\CommandeBundle\Twig\Extension\CaisseExtension A Back\CommandeBundle\Twig\Extension\CaisseExtension instance.
     */
    protected function getCaisse_TwigExtensionService()
    {
        return $this->services['caisse.twig_extension'] = new \Back\CommandeBundle\Twig\Extension\CaisseExtension($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'client.security.interactive_login_listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Main\FrontBundle\Listener\AuthenticationListener A Main\FrontBundle\Listener\AuthenticationListener instance.
     */
    protected function getClient_Security_InteractiveLoginListenerService()
    {
        return $this->services['client.security.interactive_login_listener'] = new \Main\FrontBundle\Listener\AuthenticationListener($this->get('doctrine.orm.default_entity_manager'), $this->get('security.context'));
    }

    /**
     * Gets the 'contact.twig_extension' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Back\PartnerBundle\Twig\Extension\ContactExtension A Back\PartnerBundle\Twig\Extension\ContactExtension instance.
     */
    protected function getContact_TwigExtensionService()
    {
        return $this->services['contact.twig_extension'] = new \Back\PartnerBundle\Twig\Extension\ContactExtension($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    {
        return $this->services['dcs_rating.manager.rating.default'] = new \DCS\RatingBundle\Entity\RatingManager($this->get('event_dispatcher'), $this->get('doctrine.orm.default_entity_manager'), 'Back\\DealBundle\\Entity\\Rating');
    }
    ...
    {
        return $this->services['dcs_rating.manager.vote.default'] = new \DCS\RatingBundle\Entity\VoteManager($this->get('event_dispatcher'), $this->get('doctrine.orm.default_entity_manager'), 'Back\\DealBundle\\Entity\\Vote');
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'devbigdeal', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b->setNamespace('sf2orm_default_0d2ae3e7f2e7773636263d29756349eb');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_0d2ae3e7f2e7773636263d29756349eb');

        $d = new \Doctrine\Common\Cache\ArrayCache();
        $d->setNamespace('sf2orm_default_0d2ae3e7f2e7773636263d29756349eb');

        $e = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(array(($this->targetDirs[3].'/vendor/damianociarla/rating-bundle/Resources/config/doctrine') => 'DCS\\RatingBundle\\Entity'));
        $e->setGlobalBasename('mapping');

        $f = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/src/Back/DashBundle/Entity'), 1 => ($this->targetDirs[3].'/src/Back/PlanningBundle/Entity'), 2 => ($this->targetDirs[3].'/src/Back/ContractBundle/Entity'), 3 => ($this->targetDirs[3].'/src/Back/DealBundle/Entity'), 4 => ($this->targetDirs[3].'/src/User/UserBundle/Entity'), 5 => ($this->targetDirs[3].'/src/Back/PartnerBundle/Entity'), 6 => ($this->targetDirs[3].'/src/Back/CommandeBundle/Entity'), 7 => ($this->targetDirs[3].'/src/Main/FrontBundle/Entity'), 8 => ($this->targetDirs[3].'/src/Main/BookingBundle/Entity'), 9 => ($this->targetDirs[3].'/src/Back/PageBundle/Entity')));

        $g = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $g->addDriver($e, 'DCS\\RatingBundle\\Entity');
        $g->addDriver($f, 'Back\\DashBundle\\Entity');
        $g->addDriver($f, 'Back\\PlanningBundle\\Entity');
        $g->addDriver($f, 'Back\\ContractBundle\\Entity');
        $g->addDriver($f, 'Back\\DealBundle\\Entity');
        $g->addDriver($f, 'User\\UserBundle\\Entity');
        $g->addDriver($f, 'Back\\PartnerBundle\\Entity');
        $g->addDriver($f, 'Back\\CommandeBundle\\Entity');
        $g->addDriver($f, 'Main\\FrontBundle\\Entity');
        $g->addDriver($f, 'Main\\BookingBundle\\Entity');
        $g->addDriver($f, 'Back\\PageBundle\\Entity');
        ...
        $h->setEntityNamespaces(array('DCSRatingBundle' => 'DCS\\RatingBundle\\Entity', 'BackDashBundle' => 'Back\\DashBundle\\Entity', 'BackPlanningBundle' => 'Back\\PlanningBundle\\Entity', 'BackContractBundle' => 'Back\\ContractBundle\\Entity', 'BackDealBundle' => 'Back\\DealBundle\\Entity', 'UserUserBundle' => 'User\\UserBundle\\Entity', 'BackPartnerBundle' => 'Back\\PartnerBundle\\Entity', 'BackCommandeBundle' => 'Back\\CommandeBundle\\Entity', 'MainFrontBundle' => 'Main\\FrontBundle\\Entity', 'MainBookingBundle' => 'Main\\BookingBundle\\Entity', 'BackPageBundle' => 'Back\\PageBundle\\Entity'));
        ...
        $h->addCustomDatetimeFunction('DATE_FORMAT', 'Main\\BookingBundle\\DQL\\DateFormatFunction');
        $h->addCustomDatetimeFunction('DATEDIFF', 'Back\\CommandeBundle\\DQL\\DateDiff');
        $h->addCustomDatetimeFunction('GROUP_CONCAT', 'Main\\FrontBundle\\DQL\\GroupConcat');
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListenerService('kernel.request', array(0 => 'notiflistener', 1 => 'onKernelRequest'), 0);
        ...
        $instance->addListenerService('kernel.exception', array(0 => 'kernel.listener.main_front_exception_listener', 1 => 'onKernelException'), 0);
        $instance->addListenerService('security.interactive_login', array(0 => 'client.security.interactive_login_listener', 1 => 'onAuthenticationSuccess'), 0);
    ...
    {
        return $this->services['form.csrf_provider'] = new \Symfony\Component\Form\Extension\Csrf\CsrfProvider\SessionCsrfProvider($this->get('session'), 'AIzaSyB9BnxF_KU_Eb69t-ptWE8t8FxY_FuXwQU');
    }
    ...
    {
        return $this->services['fos_user.registration.form.factory'] = new \FOS\UserBundle\Form\Factory\FormFactory($this->get('form.factory'), 'fos_user_registration_form', 'user_userbundle_registration', array(0 => 'Registration', 1 => 'Default'));
    }
    ...
    /**
     * Gets the 'kernel.listener.main_front_exception_listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Main\FrontBundle\Listener\ExceptionListener A Main\FrontBundle\Listener\ExceptionListener instance.
     */
    protected function getKernel_Listener_MainFrontExceptionListenerService()
    {
        return $this->services['kernel.listener.main_front_exception_listener'] = new \Main\FrontBundle\Listener\ExceptionListener($this->get('templating'), $this->get('kernel'));
    }
    ...
    {
        return $this->services['knp_menu.renderer.twig'] = new \Knp\Menu\Renderer\TwigRenderer($this->get('twig'), 'BackDashBundle:Menu:knp_menu.html.twig', $this->get('knp_menu.matcher'), array());
    }
    ...
    {
        return $this->services['knp_paginator.subscriber.sliding_pagination'] = new \Knp\Bundle\PaginatorBundle\Subscriber\SlidingPaginationSubscriber(array('defaultPaginationTemplate' => 'BackDashBundle:Pagination:sliding.html.twig', 'defaultSortableTemplate' => 'KnpPaginatorBundle:Pagination:sortable_link.html.twig', 'defaultFiltrationTemplate' => 'KnpPaginatorBundle:Pagination:filtration.html.twig', 'defaultPageRange' => 5));
    }
    ...
    {
        return $this->services['liip_imagine.cache.signer'] = new \Liip\ImagineBundle\Imagine\Cache\Signer('AIzaSyB9BnxF_KU_Eb69t-ptWE8t8FxY_FuXwQU');
    }
    ...
    {
        return $this->services['liip_imagine.filter.configuration'] = new \Liip\ImagineBundle\Imagine\Filter\FilterConfiguration(array('cache' => array('quality' => 100, 'jpeg_quality' => NULL, 'png_compression_level' => NULL, 'png_compression_filter' => NULL, 'format' => NULL, 'animated' => false, 'cache' => NULL, 'data_loader' => NULL, 'default_image' => NULL, 'filters' => array(), 'post_processors' => array()), 'facebook_share' => array('quality' => 100, 'filters' => array('thumbnail' => array('size' => array(0 => 700, 1 => 400), 'mode' => 'inset', 'format' => 'png')), 'jpeg_quality' => NULL, 'png_compression_level' => NULL, 'png_compression_filter' => NULL, 'format' => NULL, 'animated' => false, 'cache' => NULL, 'data_loader' => NULL, 'default_image' => NULL, 'post_processors' => array()), 'user_profil' => array('quality' => 100, 'filters' => array('thumbnail' => array('size' => array(0 => 80, 1 => 80), 'mode' => 'inset', 'format' => 'png')), 'jpeg_quality' => NULL, 'png_compression_level' => NULL, 'png_compression_filter' => NULL, 'format' => NULL, 'animated' => false, 'cache' => NULL, 'data_loader' => NULL, 'default_image' => NULL, 'post_processors' => array()), 'sliddetaildeal' => array('quality' => 100, 'filters' => array('thumbnail' => array('size' => array(0 => 700, 1 => 400), 'mode' => 'inset', 'format' => 'png')), 'jpeg_quality' => NULL, 'png_compression_level' => NULL, 'png_compression_filter' => NULL, 'format' => NULL, 'animated' => false, 'cache' => NULL, 'data_loader' => NULL, 'default_image' => NULL, 'post_processors' => array()), 'thumbdetaildeal' => array('quality' => 100, 'filters' => array('thumbnail' => array('size' => array(0 => 125, 1 => 70), 'mode' => 'inset', 'format' => 'png')), 'jpeg_quality' => NULL, 'png_compression_level' => NULL, 'png_compression_filter' => NULL, 'format' => NULL, 'animated' => false, 'cache' => NULL, 'data_loader' => NULL, 'default_image' => NULL, 'post_processors' => array()), 'thumbcommandedeal' => array('quality' => 100, 'filters' => array('thumbnail' => array('size' => array(0 => 125, 1 => 70), 'mode' => 'inset', 'format' => 'png')), 'jpeg_quality' => NULL, 'png_compression_level' => NULL, 'png_compression_filter' => NULL, 'format' => NULL, 'animated' => false, 'cache' => NULL, 'data_loader' => NULL, 'default_image' => NULL, 'post_processors' => array()), 'homedeal' => array('quality' => 100, 'filters' => array('thumbnail' => array('size' => array(0 => 475, 1 => 270), 'mode' => 'inset', 'format' => 'png')), 'jpeg_quality' => NULL, 'png_compression_level' => NULL, 'png_compression_filter' => NULL, 'format' => NULL, 'animated' => false, 'cache' => NULL, 'data_loader' => NULL, 'default_image' => NULL, 'post_processors' => array()), 'jcarouselhome' => array('quality' => 100, 'filters' => array('thumbnail' => array('size' => array(0 => 980, 1 => 390), 'mode' => 'inset', 'format' => 'png')), 'jpeg_quality' => NULL, 'png_compression_level' => NULL, 'png_compression_filter' => NULL, 'format' => NULL, 'animated' => false, 'cache' => NULL, 'data_loader' => NULL, 'default_image' => NULL, 'post_processors' => array()), 'serviceclient' => array('quality' => 70, 'filters' => array('thumbnail' => array('size' => array(0 => 100, 1 => 100), 'mode' => 'inset', 'format' => 'png')), 'jpeg_quality' => NULL, 'png_compression_level' => NULL, 'png_compression_filter' => NULL, 'format' => NULL, 'animated' => false, 'cache' => NULL, 'data_loader' => NULL, 'default_image' => NULL, 'post_processors' => array())));
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \User\UserBundle\Listener\LoginListener A User\UserBundle\Listener\LoginListener instance.
     */
    protected function getLoginListenerService()
    {
        return $this->services['login_listener'] = new \User\UserBundle\Listener\LoginListener($this->get('security.context'), $this->get('doctrine'));
    }

    /**
     * Gets the 'md5salted_encoder' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Main\FrontBundle\Service\Md5Salted A Main\FrontBundle\Service\Md5Salted instance.
     */
    protected function getMd5saltedEncoderService()
    {
        return $this->services['md5salted_encoder'] = new \Main\FrontBundle\Service\Md5Salted();
    }
    ...
    /**
     * Gets the 'notiflistener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Back\CommandeBundle\Listener\NotifListener A Back\CommandeBundle\Listener\NotifListener instance.
     */
    protected function getNotiflistenerService()
    {
        return $this->services['notiflistener'] = new \Back\CommandeBundle\Listener\NotifListener($this, $this->get('session'), $this->get('doctrine.orm.default_entity_manager'));
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Back\DashBundle\Listener\SecurityListener A Back\DashBundle\Listener\SecurityListener instance.
     */
    protected function getPageLoadListenerService()
    {
        return $this->services['page_load_listener'] = new \Back\DashBundle\Listener\SecurityListener($this->get('templating'), $this->get('router'), $this->get('security.context'));
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('FOS\\UserBundle\\Model\\UserInterface' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'sha512', 1 => true, 2 => 5000)), 'Symfony\\Component\\Security\\Core\\User\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'md5', 1 => true, 2 => 5000)), 'Back\\CommandeBundle\\Entity\\Client' => $this->get('md5salted_encoder')));
    }
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.dev' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/(_(profiler|wdt)|css|images|js)/'), 'security.firewall.map.context.main' => new \Symfony\Component\HttpFoundation\RequestMatcher('/dash'), 'security.firewall.map.context.client' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/'))), $this->get('event_dispatcher'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_ClientService()
    {
        ...
        $h = new \Symfony\Component\Security\Http\RememberMe\TokenBasedRememberMeServices(array(0 => $b), 'AIzaSyB9BnxF_KU_Eb69t-ptWE8t8FxY_FuXwQU', 'client', array('lifetime' => 31536000, 'path' => '/', 'domain' => NULL, 'name' => 'REMEMBERME', 'secure' => false, 'httponly' => true, 'always_remember_me' => false, 'remember_me_parameter' => '_remember_me'), $c);

        $i = new \Symfony\Component\Security\Http\Firewall\LogoutListener($a, $e, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($e, '/connexion.html'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => 'logout_client'));
        $i->addHandler(new \Symfony\Component\Security\Http\Logout\SessionLogoutHandler());
        $i->addHandler($h);

        $j = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationSuccessHandler($e, array('login_path' => 'identification', 'always_use_default_target_path' => false, 'use_referer' => true, 'default_target_path' => '/compte.html', 'target_path_parameter' => '_target_path'));
        $j->setProviderKey('client');

        $k = new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $g, $this->get('security.authentication.session_strategy'), $e, 'client', $j, new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($f, $e, array('login_path' => 'identification', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'), $c), array('check_path' => 'login_check_client', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $c, $d);
        $k->setRememberMeServices($h);

        return $this->services['security.firewall.map.context.client'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('fos_user.user_provider.username'), 1 => $b), 'client', $c, $d), 2 => $i, 3 => $k, 4 => new \Symfony\Component\Security\Http\Firewall\RememberMeListener($a, $h, $g, $c, $d), 5 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '57c02421a153e', $c), 6 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $e, 'client', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($f, $e, 'identification', false), NULL, NULL, $c, false));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $f = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationSuccessHandler($d, array('default_target_path' => '/dash/home', 'always_use_default_target_path' => false, 'login_path' => 'fos_user_security_login', 'use_referer' => true, 'target_path_parameter' => '_target_path'));
        $f->setProviderKey('main');

        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('fos_user.user_provider.username'), 1 => $this->get('security.user.provider.concrete.in_memory')), 'main', $b, $c), 2 => new \Symfony\Component\Security\Http\Firewall\LogoutListener($a, $d, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($d, 'fos_user_security_login'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => 'fos_user_security_logout')), 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $this->get('security.authentication.manager'), $this->get('security.authentication.session_strategy'), $d, 'main', $f, new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($e, $d, array('failure_path' => NULL, 'login_path' => 'fos_user_security_login', 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'), $b), array('use_forward' => true, 'check_path' => 'fos_user_security_check', 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $b, $c, $this->get('form.csrf_provider')), 4 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $d, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $d, 'fos_user_security_login', true), NULL, NULL, $b, false));
    }
    ...
    protected function getTemplating_Helper_LogoutUrlService()
    {
        ...
        $instance->registerListener('client', 'logout_client', 'logout', '_csrf_token', NULL);
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('xlf', ($this->targetDirs[3].'/src/Back/DashBundle/Resources/translations/messages.fr.xlf'), 'fr', 'messages');
        $instance->addResource('xlf', ($this->targetDirs[3].'/src/Back/PlanningBundle/Resources/translations/messages.fr.xlf'), 'fr', 'messages');
        $instance->addResource('xlf', ($this->targetDirs[3].'/src/Back/ContractBundle/Resources/translations/messages.fr.xlf'), 'fr', 'messages');
        $instance->addResource('xlf', ($this->targetDirs[3].'/src/Back/DealBundle/Resources/translations/messages.fr.xlf'), 'fr', 'messages');
        $instance->addResource('yml', ($this->targetDirs[3].'/src/User/UserBundle/Resources/translations/messages.fr.yml'), 'fr', 'messages');
        $instance->addResource('xlf', ($this->targetDirs[3].'/src/User/UserBundle/Resources/translations/messages.fr.xlf'), 'fr', 'messages');
        $instance->addResource('yml', ($this->targetDirs[3].'/src/User/UserBundle/Resources/translations/FOSUserBundle.fr.yml'), 'fr', 'FOSUserBundle');
        $instance->addResource('xlf', ($this->targetDirs[3].'/src/Back/PartnerBundle/Resources/translations/messages.fr.xlf'), 'fr', 'messages');
        $instance->addResource('xlf', ($this->targetDirs[3].'/src/Back/CommandeBundle/Resources/translations/messages.fr.xlf'), 'fr', 'messages');
        $instance->addResource('xlf', ($this->targetDirs[3].'/src/Main/FrontBundle/Resources/translations/messages.fr.xlf'), 'fr', 'messages');
        $instance->addResource('xlf', ($this->targetDirs[3].'/src/Main/BookingBundle/Resources/translations/messages.fr.xlf'), 'fr', 'messages');
        $instance->addResource('xlf', ($this->targetDirs[3].'/src/Back/PageBundle/Resources/translations/messages.fr.xlf'), 'fr', 'messages');
        $instance->addResource('xlf', ($this->targetDirs[3].'/src/Main/RatingclientBundle/Resources/translations/messages.fr.xlf'), 'fr', 'messages');
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension($this->get('back.twig.dash_extension'));
        $instance->addExtension($this->get('booking.twig_extension'));
        $instance->addExtension($this->get('caisse.twig_extension'));
        $instance->addExtension($this->get('contact.twig_extension'));
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), true, array(), array(0 => 'BackCommandeBundle', 1 => 'MainFrontBundle', 2 => 'BackPartnerBundle', 3 => 'BackPlanningBundle', 4 => 'BackDealBundle', 5 => 'BackDashBundle'), $this->get('assetic.value_supplier.default', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
        ...
        $instance->addExtension($this->get('your.own.twig.controller_action_extension'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/vendor/damianociarla/rating-bundle/Resources/views'), 'DCSRating');
        $instance->addPath(($this->targetDirs[3].'/src/Back/DashBundle/Resources/views'), 'BackDash');
        $instance->addPath(($this->targetDirs[3].'/src/Back/PlanningBundle/Resources/views'), 'BackPlanning');
        $instance->addPath(($this->targetDirs[3].'/src/Back/ContractBundle/Resources/views'), 'BackContract');
        $instance->addPath(($this->targetDirs[3].'/src/Back/DealBundle/Resources/views'), 'BackDeal');
        $instance->addPath(($this->targetDirs[3].'/src/User/UserBundle/Resources/views'), 'UserUser');
        $instance->addPath(($this->targetDirs[3].'/src/Back/PartnerBundle/Resources/views'), 'BackPartner');
        $instance->addPath(($this->targetDirs[3].'/src/Back/CommandeBundle/Resources/views'), 'BackCommande');
        $instance->addPath(($this->targetDirs[3].'/src/Main/FrontBundle/Resources/views'), 'MainFront');
        $instance->addPath(($this->targetDirs[3].'/src/Main/BookingBundle/Resources/views'), 'MainBooking');
        $instance->addPath(($this->targetDirs[3].'/src/Back/PageBundle/Resources/views'), 'BackPage');
        $instance->addPath(($this->targetDirs[3].'/src/Main/RestBundle/Resources/views'), 'MainRest');
        $instance->addPath(($this->targetDirs[3].'/src/Main/RatingclientBundle/Resources/views'), 'MainRatingclient');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('AIzaSyB9BnxF_KU_Eb69t-ptWE8t8FxY_FuXwQU');
    }

    /**
     * Gets the 'user_user.registration.form.type' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \User\UserBundle\Form\Type\RegistrationFormType A User\UserBundle\Form\Type\RegistrationFormType instance.
     */
    protected function getUserUser_Registration_Form_TypeService()
    {
        return $this->services['user_user.registration.form.type'] = new \User\UserBundle\Form\Type\RegistrationFormType('User\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['white_october_breadcrumbs.helper'] = new \WhiteOctober\BreadcrumbsBundle\Templating\Helper\BreadcrumbsHelper($this->get('templating'), $this->get('white_october_breadcrumbs'), array('itemClass' => 'active', 'separator' => '/', 'separatorClass' => 'separator', 'listId' => 'wo-breadcrumbs', 'listClass' => 'breadcrumb', 'linkRel' => '', 'locale' => NULL, 'translation_domain' => NULL, 'viewTemplate' => 'WhiteOctoberBreadcrumbsBundle::breadcrumbs.html.twig'));
    }
    ...
    /**
     * Gets the 'your.own.twig.controller_action_extension' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Main\FrontBundle\Twig\Extension\ControllerActionExtension A Main\FrontBundle\Twig\Extension\ControllerActionExtension instance.
     */
    protected function getYour_Own_Twig_ControllerActionExtensionService()
    {
        $this->services['your.own.twig.controller_action_extension'] = $instance = new \Main\FrontBundle\Twig\Extension\ControllerActionExtension();
    ...
    {
        return $this->services['security.access.decision_manager'] = new \Symfony\Component\Security\Core\Authorization\AccessDecisionManager(array(0 => new \Symfony\Component\Security\Core\Authorization\Voter\RoleHierarchyVoter(new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_CLIENT' => array(0 => 'ROLE_CLIENT'), 'PARTENAIRE' => array(0 => 'PARTENAIRE'), 'CAISSIER' => array(0 => 'CAISSIER'), 'COMMERCIAL' => array(0 => 'COMMERCIAL'), 'REDACTEUR' => array(0 => 'REDACTEUR'), 'PALAINER' => array(0 => 'PALAINER'), 'CHEFSERVISE' => array(0 => 'CHEFSERVISE'), 'SERVICECLIENT' => array(0 => 'SERVICECLIENT'), 'ROLE_SUPER_ADMIN' => array(0 => 'ROLE_SUPER_ADMIN')))), 1 => new \Symfony\Component\Security\Core\Authorization\Voter\AuthenticatedVoter($this->get('security.authentication.trust_resolver'))), 'affirmative', false, true);
    }
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        ...
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($this->get('fos_user.user_provider.username'), $a, 'main', $b, true), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($this->get('security.user.provider.concrete.in_memory'), $a, 'client', $b, true), 2 => new \Symfony\Component\Security\Core\Authentication\Provider\RememberMeAuthenticationProvider($a, 'AIzaSyB9BnxF_KU_Eb69t-ptWE8t8FxY_FuXwQU', 'client'), 3 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('57c02421a153e')), true);
    ...
    {
        return $this->services['security.user.provider.concrete.in_memory'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'Back\\CommandeBundle\\Entity\\Client', 'username', NULL);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'BackDashBundle' => 'Back\\DashBundle\\BackDashBundle',
                'BackPlanningBundle' => 'Back\\PlanningBundle\\BackPlanningBundle',
                'BackContractBundle' => 'Back\\ContractBundle\\BackContractBundle',
                'BackDealBundle' => 'Back\\DealBundle\\BackDealBundle',
                'UserUserBundle' => 'User\\UserBundle\\UserUserBundle',
                'BackPartnerBundle' => 'Back\\PartnerBundle\\BackPartnerBundle',
                'BackCommandeBundle' => 'Back\\CommandeBundle\\BackCommandeBundle',
                'MainFrontBundle' => 'Main\\FrontBundle\\MainFrontBundle',
                'MainBookingBundle' => 'Main\\BookingBundle\\MainBookingBundle',
                'BackPageBundle' => 'Back\\PageBundle\\BackPageBundle',
                'MainRestBundle' => 'Main\\RestBundle\\MainRestBundle',
                'MainRatingclientBundle' => 'Main\\RatingclientBundle\\MainRatingclientBundle',
            ...
            'locale' => 'fr',
            'secret' => 'AIzaSyB9BnxF_KU_Eb69t-ptWE8t8FxY_FuXwQU',
            ...
            'kernel.secret' => 'AIzaSyB9BnxF_KU_Eb69t-ptWE8t8FxY_FuXwQU',
            ...
            'validator.mapping.loader.yaml_files_loader.mapping_files' => array(
                0 => ($this->targetDirs[3].'/src/User/UserBundle/Resources/config/validation.yml'),
            ),
            ...
            'assetic.bundles' => array(
                0 => 'BackCommandeBundle',
                1 => 'MainFrontBundle',
                2 => 'BackPartnerBundle',
                3 => 'BackPlanningBundle',
                4 => 'BackDealBundle',
                5 => 'BackDashBundle',
            ),
            ...
            'knp_menu.renderer.twig.template' => 'BackDashBundle:Menu:knp_menu.html.twig',
            ...
            'fos_user.registration.form.type' => 'user_userbundle_registration',
            ...
            'knp_paginator.template.pagination' => 'BackDashBundle:Pagination:sliding.html.twig',
            ...
            'dcs_rating.model.rating.class' => 'Back\\DealBundle\\Entity\\Rating',
            'dcs_rating.model.vote.class' => 'Back\\DealBundle\\Entity\\Vote',
