 ...
 */
class TicketHostorique extends \Back\CommandeBundle\Entity\TicketHostorique implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Back\\CommandeBundle\\Entity\\TicketHostorique' . "\0" . 'id', '' . "\0" . 'Back\\CommandeBundle\\Entity\\TicketHostorique' . "\0" . 'dcr', '' . "\0" . 'Back\\CommandeBundle\\Entity\\TicketHostorique' . "\0" . 'action');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TicketHostorique $proxy) {
