 ...
 */
class Smstmp extends \Back\DashBundle\Entity\Smstmp implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Back\\DashBundle\\Entity\\Smstmp' . "\0" . 'id', '' . "\0" . 'Back\\DashBundle\\Entity\\Smstmp' . "\0" . 'phone', '' . "\0" . 'Back\\DashBundle\\Entity\\Smstmp' . "\0" . 'sms', '' . "\0" . 'Back\\DashBundle\\Entity\\Smstmp' . "\0" . 'operator');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Smstmp $proxy) {
