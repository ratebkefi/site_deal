 ...
 */
class TicketHistorique extends \Back\CommandeBundle\Entity\TicketHistorique implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Back\\CommandeBundle\\Entity\\TicketHistorique' . "\0" . 'id', '' . "\0" . 'Back\\CommandeBundle\\Entity\\TicketHistorique' . "\0" . 'dcr', '' . "\0" . 'Back\\CommandeBundle\\Entity\\TicketHistorique' . "\0" . 'user', '' . "\0" . 'Back\\CommandeBundle\\Entity\\TicketHistorique' . "\0" . 'ticket', '' . "\0" . 'Back\\CommandeBundle\\Entity\\TicketHistorique' . "\0" . 'action');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TicketHistorique $proxy) {
