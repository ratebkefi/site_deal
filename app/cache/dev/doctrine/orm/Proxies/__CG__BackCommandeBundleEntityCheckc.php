 ...
 */
class Checkc extends \Back\CommandeBundle\Entity\Checkc implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Back\\CommandeBundle\\Entity\\Checkc' . "\0" . 'id', '' . "\0" . 'Back\\CommandeBundle\\Entity\\Checkc' . "\0" . 'dcr', '' . "\0" . 'Back\\CommandeBundle\\Entity\\Checkc' . "\0" . 'coupon');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Checkc $proxy) {
