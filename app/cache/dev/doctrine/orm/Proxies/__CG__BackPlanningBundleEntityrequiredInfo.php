 ...
 */
class requiredInfo extends \Back\PlanningBundle\Entity\requiredInfo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Back\\PlanningBundle\\Entity\\requiredInfo' . "\0" . 'id', '' . "\0" . 'Back\\PlanningBundle\\Entity\\requiredInfo' . "\0" . 'question', '' . "\0" . 'Back\\PlanningBundle\\Entity\\requiredInfo' . "\0" . 'categoryId', 'responserequiredinfo');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (requiredInfo $proxy) {
