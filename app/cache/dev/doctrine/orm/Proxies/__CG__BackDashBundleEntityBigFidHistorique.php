 ...
 */
class BigFidHistorique extends \Back\DashBundle\Entity\BigFidHistorique implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Back\\DashBundle\\Entity\\BigFidHistorique' . "\0" . 'id', '' . "\0" . 'Back\\DashBundle\\Entity\\BigFidHistorique' . "\0" . 'montant', '' . "\0" . 'Back\\DashBundle\\Entity\\BigFidHistorique' . "\0" . 'dcr', '' . "\0" . 'Back\\DashBundle\\Entity\\BigFidHistorique' . "\0" . 'motif', '' . "\0" . 'Back\\DashBundle\\Entity\\BigFidHistorique' . "\0" . 'client', '' . "\0" . 'Back\\DashBundle\\Entity\\BigFidHistorique' . "\0" . 'operation');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (BigFidHistorique $proxy) {
    ...
    public function setOperation($operation)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setOperation', array($operation));
