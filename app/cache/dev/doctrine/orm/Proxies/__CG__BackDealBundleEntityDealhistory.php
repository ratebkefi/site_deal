 ...
 */
class Dealhistory extends \Back\DealBundle\Entity\Dealhistory implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Back\\DealBundle\\Entity\\Dealhistory' . "\0" . 'id', '' . "\0" . 'Back\\DealBundle\\Entity\\Dealhistory' . "\0" . 'dcr', '' . "\0" . 'Back\\DealBundle\\Entity\\Dealhistory' . "\0" . 'type', '' . "\0" . 'Back\\DealBundle\\Entity\\Dealhistory' . "\0" . 'deal');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Dealhistory $proxy) {
