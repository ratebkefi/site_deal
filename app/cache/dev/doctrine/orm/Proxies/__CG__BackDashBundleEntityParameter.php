 ...
 */
class Parameter extends \Back\DashBundle\Entity\Parameter implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Back\\DashBundle\\Entity\\Parameter' . "\0" . 'id', '' . "\0" . 'Back\\DashBundle\\Entity\\Parameter' . "\0" . 'valeur');
        }
