...
namespace Proxies\__CG__\Main\BookingBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Booking extends \Main\BookingBundle\Entity\Booking implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Main\\BookingBundle\\Entity\\Booking' . "\0" . 'id', '' . "\0" . 'Main\\BookingBundle\\Entity\\Booking' . "\0" . 'booking', '' . "\0" . 'Main\\BookingBundle\\Entity\\Booking' . "\0" . 'dcr', '' . "\0" . 'Main\\BookingBundle\\Entity\\Booking' . "\0" . 'coupon', '' . "\0" . 'Main\\BookingBundle\\Entity\\Booking' . "\0" . 'deal');
        }
