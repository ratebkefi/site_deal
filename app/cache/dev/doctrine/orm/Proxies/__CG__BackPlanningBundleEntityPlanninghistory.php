 ...
 */
class Planninghistory extends \Back\PlanningBundle\Entity\Planninghistory implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Back\\PlanningBundle\\Entity\\Planninghistory' . "\0" . 'id', '' . "\0" . 'Back\\PlanningBundle\\Entity\\Planninghistory' . "\0" . 'dcr', '' . "\0" . 'Back\\PlanningBundle\\Entity\\Planninghistory' . "\0" . 'type', '' . "\0" . 'Back\\PlanningBundle\\Entity\\Planninghistory' . "\0" . 'planning');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Planninghistory $proxy) {
