 ...
 */
class TicketNote extends \Back\CommandeBundle\Entity\TicketNote implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Back\\CommandeBundle\\Entity\\TicketNote' . "\0" . 'id', '' . "\0" . 'Back\\CommandeBundle\\Entity\\TicketNote' . "\0" . 'dcr', '' . "\0" . 'Back\\CommandeBundle\\Entity\\TicketNote' . "\0" . 'message', '' . "\0" . 'Back\\CommandeBundle\\Entity\\TicketNote' . "\0" . 'user', '' . "\0" . 'Back\\CommandeBundle\\Entity\\TicketNote' . "\0" . 'ticket');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TicketNote $proxy) {
