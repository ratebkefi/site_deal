 ...
 */
class Notification extends \Back\DashBundle\Entity\Notification implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Back\\DashBundle\\Entity\\Notification' . "\0" . 'id', '' . "\0" . 'Back\\DashBundle\\Entity\\Notification' . "\0" . 'name', '' . "\0" . 'Back\\DashBundle\\Entity\\Notification' . "\0" . 'lien', '' . "\0" . 'Back\\DashBundle\\Entity\\Notification' . "\0" . 'icone', '' . "\0" . 'Back\\DashBundle\\Entity\\Notification' . "\0" . 'etat', '' . "\0" . 'Back\\DashBundle\\Entity\\Notification' . "\0" . 'dcr', '' . "\0" . 'Back\\DashBundle\\Entity\\Notification' . "\0" . 'user');
        }
