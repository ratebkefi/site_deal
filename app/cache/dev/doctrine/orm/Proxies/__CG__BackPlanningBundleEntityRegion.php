 ...
 */
class Region extends \Back\PlanningBundle\Entity\Region implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Back\\PlanningBundle\\Entity\\Region' . "\0" . 'id', '' . "\0" . 'Back\\PlanningBundle\\Entity\\Region' . "\0" . 'name', '' . "\0" . 'Back\\PlanningBundle\\Entity\\Region' . "\0" . 'planning', 'user');
        }
