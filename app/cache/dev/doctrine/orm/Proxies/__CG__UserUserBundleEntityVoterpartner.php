 ...
 */
class Voterpartner extends \User\UserBundle\Entity\Voterpartner implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'User\\UserBundle\\Entity\\Voterpartner' . "\0" . 'id', '' . "\0" . 'User\\UserBundle\\Entity\\Voterpartner' . "\0" . 'rate', '' . "\0" . 'User\\UserBundle\\Entity\\Voterpartner' . "\0" . 'partner', '' . "\0" . 'User\\UserBundle\\Entity\\Voterpartner' . "\0" . 'voter');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Voterpartner $proxy) {
