 ...
 */
class MessageTicket extends \Back\CommandeBundle\Entity\MessageTicket implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Back\\CommandeBundle\\Entity\\MessageTicket' . "\0" . 'id', '' . "\0" . 'Back\\CommandeBundle\\Entity\\MessageTicket' . "\0" . 'message', '' . "\0" . 'Back\\CommandeBundle\\Entity\\MessageTicket' . "\0" . 'file', '' . "\0" . 'Back\\CommandeBundle\\Entity\\MessageTicket' . "\0" . 'dpa');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MessageTicket $proxy) {
