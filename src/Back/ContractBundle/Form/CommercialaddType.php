...
class CommercialaddType extends AbstractType{
    /**
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('datenaisse', 'date', array('label' => "Date de naissance",'widget' => 'single_text','attr'   =>  array('class'   => 'datepicker'),'required'=>false, 'format' => 'dd/MM/yyyy'))
            ->add('cin', 'text', array('label' => "CIN",'attr'=>array('class'=>'span10', 'required'=>false)))
            ->add('datecin','date', array('label' => "Date de livraison CIN",'widget' => 'single_text','attr'   =>  array('class'   => 'datepicker'),'required'=>false,  'format' => 'dd/MM/yyyy'))
    ...
    {
        return 'back_commandebundle_cassier';
    }
}