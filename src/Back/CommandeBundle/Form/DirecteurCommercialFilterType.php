...
class DirecteurCommercialFilterType extends AbstractType
{
        /**
    ...
    {
        $builder
            ->add('name', 'entity', array('label' => "Nom", 'empty_value' => 'Choisissez un directeur commercial',
                'class' => 'UserUserBundle:User',
                'query_builder'=> function(UserRepository $r) {
                    return  $r->createQueryBuilder("u")
                        ->where('u.roles LIKE :roles')
                        ->setParameter('roles', '%"DIRECTEURCOMMERCIAL"%');
    ...
    {
        return 'back_commandebundle_directeurcommercial';
    }
}
