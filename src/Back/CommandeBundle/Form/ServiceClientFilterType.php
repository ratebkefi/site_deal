...
class ServiceClientFilterType extends AbstractType
{
        /**
    ...
    {
        $builder
            ->add('name', 'entity', array('label' => "Nom", 'empty_value' => 'Choisissez un agent service client',
            ...
            ->add('email', 'entity', array('label' => "E-mail", 'empty_value' => 'Choisissez email agent service client',
                'class' => 'UserUserBundle:User',
                'query_builder'=> function(UserRepository $r) {
                    return  $r->createQueryBuilder("u")
                        ->where('u.roles LIKE :roles')
    ...
    {
        return 'back_commandebundle_serviceclientfilter';
    }
}
