...
class TwigExtension extends \Twig_Extension
{
    ...
    {
        return array(//getCouponFacturable
            'listCouponConsomer' => new \Twig_Filter_Method($this, 'listCouponConsomer'),
 ...
 public function listCouponConsomer($idDeal)
    {
        $listCoupon=count($this->doctrine->getRepository('BackDealBundle:Deal')->getCouponFacturable($idDeal));
    ...
    {
		$economie = $total-$valeur;
        return round($economie * 100 / $total);
    }
