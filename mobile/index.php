...
class Gateway
{
    ...
    private static $db_user = "bigdealc";
    private static $db_password = 'qHRCz7D-#%m4';
    ...
    {
       mysqli_connect(self::$db_host, self::$db_user, self::$db_password) or die("erreur de connexion au serveur");
	   $connection = mysqli_connect(self::$db_host,self::$db_user,self::$db_password);
       mysqli_select_db($connection,self::$db_name) or die("erreur de connexion a la base de donnees");
    }
